...
class TestData {
    ...
    static final int VEHICLE_NUMBER_OF_WHEELS = 2;
    ...
    static final int MOTORCYCLE_NUMBER_OF_WHEELS = 2;
    ...
    static final String CAR_ENGINE_TYPE = null;
    ...
    static final int CAR_NUMBER_OF_WHEELS = 4;
    ...
    static final String VEHICLE_TEXT_DATA = VEHICLE_PREFIX + VEHICLE_BRAND_NAME + " " + VEHICLE_IS_ELECTRICAL + " " +
            VEHICLE_NUMBER_OF_SEATS + " " + VEHICLE_NUMBER_OF_WHEELS + " " + VEHICLE_TYPE;

    static final String BIKE_TEXT_DATA = BIKE_PREFIX + BIKE_BRAND_NAME + " " + BIKE_IS_ELECTRICAL + " " +
            VEHICLE_NUMBER_OF_SEATS + " " + VEHICLE_NUMBER_OF_WHEELS + " " + BIKE_PRICE + " " + VEHICLE_TYPE;


    static final String MOTORCYCLE_TEXT_DATA = MOTORCYCLE_PREFIX + MOTORCYCLE_BRAND_NAME + " " + VEHICLE_IS_ELECTRICAL +
            " " + MOTORCYCLE_ENGINE_TYPE + " " + +MOTORCYCLE_HORSE_POWER + " " + MOTOrCYCLE_MILEAGE + " " + MOTORCYCLE_NUMBER_OF_SEATS + " " +
            MOTORCYCLE_NUMBER_OF_WHEELS + " " + MOTORCYCLE_PRICE + " " + MOTORCYCLE_TRANSMISSION_TYPE + " " + MOTORCYCLE_TYPE;

    static final String CAR_TEXT_DATA = CAR_PREFIX + CAR_BRAND_NAME + " " + CAR_IS_ELECTRICAL +" "+ CAR_ENGINE_TYPE + " " +
            CAR_HORSE_POWER + " " + CAR_MILEAGE + " " + CAR_NUMBER_OF_SEATS + " " + CAR_NUMBER_OF_WHEELS + " " +
